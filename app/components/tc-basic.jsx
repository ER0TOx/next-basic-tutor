    ...
    <div className="tutor-content-blocks">
        ...
        <div className="tutor-content-inside">
          ...
          <div className="tutor-content-sub">
            ...
            <h5 style={{ width: 'fit-content', backgroundColor: 'black', color: 'white', padding: '8px 12px', borderRadius: '4px' }}>1. Next.js</h5>
...
export default Home' title='สร้างหน้าเว็บด้วย file-based routing คือการสร้างไฟล์ในโฟลเดอร์ app' language='page.jsx'/>
            <h5 style={{ width: 'fit-content', backgroundColor: 'blue', color: 'white', padding: '8px 12px', borderRadius: '4px' }}>2. React</h5>
...
export default App' title='เขียน Component ที่เป็นส่วนของ UI แล้วนำไปประกอบเป็นหน้าเว็บ' language='App.jsx'/>
            <h5 style={{ width: 'fit-content', backgroundColor: 'green', color: 'white', padding: '8px 12px', borderRadius: '4px' }}>3. Vue</h5>
...
&lt;/script&gt;' title='สร้าง Component ที่มีทั้ง Template กับ Logic ในไฟล์เดียว' language='Component.vue'/>
            <h5 style={{ width: 'fit-content', backgroundColor: 'pink', color: 'white', padding: '8px 12px', borderRadius: '4px' }}>4. Angular</h5>
